"""vLLM (self-hosted) provider — config + reasoning strategies."""
...
def replay_inline_think_text(
	...
	"""Open-weight deployments just want the thinking text back — inline
	the `<think:6124c78e>` text into content."""
...
VLLMProviderConfig = make_config(
	name="vllm",
